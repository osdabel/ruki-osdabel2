    ...
    return (
        <>
            <div className="shadowing bg-gray-50 w-screen h-17 fixed bottom-0 left-0 z-99 pb-2 flex justify-around items-center text-black">
                ...
                <Link href="/sportif18">
                    <div className='w-max h-max flex flex-col items-center '>
                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="35px" fill="#000000"><path d="m233-120 65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Z" /></svg>
                        <h6>Sportif18</h6>
                    </div>
                </Link>
            </div>
