    ...
    return (
        <>
            <div className="shadowing bg-gray-50 w-screen h-17 fixed bottom-0 left-0 z-99 pb-2 flex justify-around items-center text-black">
                ...
                <Link href="/sportif18">
                    <div className='w-max h-max flex flex-col items-center '>
                        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 0 24 24" width="35px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v3c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-5.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 10.63 21 8.55 21 6V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm-9 3h4.18c.41 2.47 2.14 4.41 4.54 5.25-.12.28-.27.54-.45.78C7.94 11.23 5 8.96 5 6zm14 0c0 2.96-2.94 5.23-6.27 6.03-.18-.24-.33-.5-.45-.78 2.4-.84 4.13-2.78 4.54-5.25H19z" /></svg>
                        <h6>Sportif18</h6>
                    </div>
                </Link>
            </div>
