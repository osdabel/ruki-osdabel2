...
const Page = () => {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gradient-to-br from-blue-500 to-indigo-600">
      <div className="bg-white shadow-lg w-80 rounded-2xl p-6">
        {/* Header */}
        {role === "siswa" ? (<h1 className="text-3xl font-bold text-center text-gray-800">Login Siswa/i</h1>) : 
        <h1 className="text-3xl font-bold text-center text-gray-800">Login Guru</h1>
        }
  ...
  <div className="relative mt-1">
    ...
    >
      {showPassword ? (
        ...
        {/* Button */}
        <button className="mt-6 w-full bg-blue-500 hover:bg-blue-600 transition-all text-white font-semibold py-2 rounded-lg shadow-sm">
          Sign In
        </button>

        {/* Register */}
        <Link href={"/TKA/signin"}>
